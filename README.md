...
- **[QUICKSTART.md](docs/QUICKSTART.md)** - Быстрый старт для разработки
- **[VPS_RECOMMENDATIONS.md](docs/VPS_RECOMMENDATIONS.md)** - Рекомендации по выбору VPS ⭐
- **[OS_RECOMMENDATIONS.md](docs/OS_RECOMMENDATIONS.md)** - Выбор операционной системы ⭐
- **[DEPLOY.md](docs/DEPLOY.md)** - Инструкция по деплою в продакшн
...
- **🔴 [MTU_FIX.md](docs/MTU_FIX.md)** - Исправление MTU для работы VPN в РФ (КРИТИЧНО!)
- **[SERVER_SELECTION.md](docs/SERVER_SELECTION.md)** - Умный выбор сервера (как в Капусте VPN) ⭐
- **[OBFUSCATION.md](docs/OBFUSCATION.md)** - Обфускация трафика и обход блокировок ⭐
...
- **🔴 [Исправление MTU для РФ](docs/MTU_FIX.md)** - если VPN не работает в РФ
- [Быстрое решение проблем](docs/QUICK_FIX_RU.md)
...
✅ **Умный выбор сервера** - Автоматический выбор лучшего сервера (как в Капусте VPN)  
✅ **USDT TRC20** - Оплата криптовалютой  
✅ **Автоматическое истечение** - Проверка и деактивация истекших подписок  
✅ **Админ панель** - Веб-интерфейс для управления пользователями, платежами и VPN  
✅ **Обход блокировок** - Оптимизировано для работы в РФ (MTU 1280, порт 443, умная локация)  
